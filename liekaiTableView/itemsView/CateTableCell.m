...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        // Initialization code
       // self.contentView.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:@"liekaibutton"]];
        self.logo = [[[UIImageView alloc] initWithFrame:CGRectMake(5, 5, 50, 50)] autorelease];
        self.logo.backgroundColor = [UIColor clearColor];
        [self.contentView addSubview:self.logo];
        
        self.title = [[[UILabel alloc] initWithFrame:CGRectMake(20, 20, 280, 20)] autorelease];
        self.title.font = [UIFont boldSystemFontOfSize:18.0];
        self.title.backgroundColor = [UIColor clearColor];
        self.title.opaque = NO;
        [self.contentView addSubview:self.title];
        
        self.subTtile = [[[UILabel alloc] initWithFrame:CGRectMake(20, 40, 280, 14)] autorelease];
